  ...
  <body>
    <div id="pagina">
      ...
      <div class="slide">
        ...
        <div class="conteudo">
          <div class="texto">
            <p>Nós queremos apresentar o nosso novo site. Use o scroll para nos acompanhar.</p>
          </div>
        </div>
      </div> <!-- #Slide -->
      ...
      <div class="slide">
        <div class="conteudo">
          <div class="texto">
            <p>Aliás, você já viu um site de compras coletivas para Mauá e Região?</p>
          </div>
        </div>
      </div> <!-- #Slide -->
    ...
    <script>
      ...
      ga('create', 'UA-39940097-1', 'compramaua.com.br');
      ga('send', 'pageview');
    </script>
  </body>
</html>